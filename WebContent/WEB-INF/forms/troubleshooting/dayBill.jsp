...
<div class="mid-box fl" id="mid-box">
    ...
    <form action="FrmDayBill" method="post" id="subForm">
        <div class="tab_box mt_20 mb_10 clear pr_20 pl_20">
            ...
            <div class="fr rightSide">
                ...
                <a href="FrmExcel?service=SvrGetDayBill&amp;exportKey=SvrDayBill&amp;templateId=SvrDayBill"><input type="button" value="查询结果导出"></a>
            </div>
        </div>
    </form>
    <div role="grid">
            ...
            <table class="tbl">
                <tbody>
                    <tr>
                        ...
                        <th class="t-head tc">微信账户总金额</th>
                        <th class="t-head tc">用户总可用金额</th>
                        <th class="t-head tc">用户正数可用余额</th>
                        <th class="t-head tc">用户负可用余额</th>
