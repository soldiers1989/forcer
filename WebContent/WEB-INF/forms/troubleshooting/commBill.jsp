...
<div class="mid-box fl" id="mid-box">
    ...
    <form action="FrmCommunityDayBill" method="post" id="subForm">
        <div class="tab_box mt_20 mb_10 clear pr_20 pl_20">
            ...
            <div class="fr rightSide">
                <input type="hidden" value="${type_ }" name="type_">
                <input type="submit" value="查询" id="sub">
                <a href="FrmCommunityDayBill.excel?service=SvrGetCommBill&amp;exportKey=SvrGetCommBill&amp;templateId=SvrGetCommBill&type_=${type_ }"><input type="button" value="查询结果导出"></a>
            </div>
        </div>
    </form>
    <div role="grid">
