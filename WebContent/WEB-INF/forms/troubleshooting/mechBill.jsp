...
<div class="mid-box fl" id="mid-box">
    ...
    <form action="FrmMechanismDayBill" method="post" id="subForm">
        <div class="tab_box mt_20 mb_10 clear pr_20 pl_20">
            ...
            <div class="fr rightSide">
                ...
                <a href="FrmMechanismDayBill.excel?service=SvrGetMechBill&amp;exportKey=SvrGetMechBill&amp;templateId=SvrGetMechBill&type_=${type_ }"><input type="button" value="查询结果导出"></a>
            </div>
        </div>
    </form>
    <div role="grid">
