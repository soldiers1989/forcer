...
<div class="forget-box">
	<form id="formid" action="FrmEditPhonePaswd.updateMobile">
		<h3 class="min-col f16 mb_10">修改手机号</h3>
		<div class="mid-keytext" id="test" style="">
			<div class="mb_20 mt_20">
				<input type="hidden" value="${oldPhone }" id="oldPhone" />
				<span class="lf-box">新手机号:</span> <input id="phone" name="phone" type="text"  class="text " placeholder="请输入您的新手机号">
			</div>
			<div class="mb_20 mt_20">
