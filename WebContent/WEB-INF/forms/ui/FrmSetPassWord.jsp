...
<div class="forget-box">
	<form id="formid" action="FrmAdminLogin.setNewPassWord">
		<h3 class="min-col f16 mb_10">设置密码</h3>
		<div class="tip">
			<ul>
		...
		<div class="mid-keytext" id="test" style="">
			<div class="mb_20 mt_20">
				<span class="lf-box">密码:</span> <input  name="newPassword" id="newPassword" type="password" class="text " placeholder="请输入您的新密码">
			</div>
			<div class="mb_20 mt_20">
			...
			<div class="tr mt_20" style="padding-right: 100px">
				已有账号?<a href="" class="min-col">登录></a>
			</div>
		</div>
	</form>
</div>
