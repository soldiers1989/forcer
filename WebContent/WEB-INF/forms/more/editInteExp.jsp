...
<body>
<form action="FrmIntegral.editIntegral">
<p><a href="FrmIntegral">返回</a></p>
	<div>
	<input type="hidden" value="up" name="up">
	<input type="hidden" value="${explains.items.UID_}"  name="UID_">
		<span>积分说明</span>
		<textarea id="editor" style="width: 290px;border-radius: 4px;padding:10px; border: 1px solid #ddd;" rows="5" cols="15"
			name="explain_">${explains.items.explain_ }</textarea>
			<script type="text/javascript">
