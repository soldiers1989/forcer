...
<body style="background-color:#ffffff;">
	...
	<div class="mid-box fl" id="mid-box">
		<div class="top pl_20 pr_20">
			<span class="min-col f16">征信管理</span>
		</div>
		...
		<div class="box clearfloat" >
			...
			<div class=" flexLayout " >
				<div class="box-left flexLayout" style="" >
					<div class="box-text">今天芝麻认证成功人数</div>
				...
				<div class="box-right flexLayout" style="justify-content:left;">
					<div class="box-text">今天获得部分免押人数</div>
			...
			<div class=" flexLayout" >
				<div class="box-left flexLayout"  >
					<div class="box-text">今天活体映像认证人数</div>
				...
				<div class="box-right flexLayout">
					<div class="box-text">今日获得免押金额</div>
