 ...
 *
 */
public class SvrHomeOrdersQuery extends AbstractService {
	...
	public IStatus execute(DataSet dataIn, DataSet dataOut) throws ServiceException {
		...
		sql.add("select o.orderId_, p.proName_,b.zhuCode_,o.sumRentMoney_,o.homeAgency_,o.sumOverMoney_, b.communityName_,");
