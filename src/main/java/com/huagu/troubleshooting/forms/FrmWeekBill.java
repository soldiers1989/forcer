 ...
 *
 */
public class FrmWeekBill extends AbstractForm {

	@Override
	public IPage execute() throws Exception {
		JspPage page = new JspPage(this, "troubleshooting/weekBill.jsp");
		LocalService getBill = new LocalService(this, "SvrGetDayBill");
        Record record = getBill.getDataIn().getHead();
        record.setField("type_", "week");
