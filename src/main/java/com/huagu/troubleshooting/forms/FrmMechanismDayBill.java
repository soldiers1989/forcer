 ...
 *
 */
public class FrmMechanismDayBill extends AbstractForm {

	@Override
	public IPage execute() throws Exception {
		JspPage page = new JspPage(this, "troubleshooting/mechBill.jsp");
		LocalService getBill = new LocalService(this, "SvrGetMechBill");
	...
	public static void main(String[] args) {
		...
		Date d = FrmMechanismDayBill.paraseStringToDate("2014-8-1");
		List<String> lst3 = FrmMechanismDayBill.getAllweekDays(d);
		for (String s3 : lst3) {
			System.out.println(s3);
		}
		System.out.println("--------------根据特定的日期‘2014-8-1’获取特定日期所在一个月的每一天--------------");
		Date d2 = FrmMechanismDayBill.paraseStringToDate("2014-8-1");
		List<String> lst4 = FrmMechanismDayBill.getAllDaysMonthByDate(d2);
		for (String s3 : lst4) {
			System.out.println(s3);
		}
	}
