 ...
 *
 */
public class SvrOrderInfo extends AbstractService {
	...
	public IStatus execute(DataSet dataIn, DataSet dataOut) throws ServiceException {
		...
		sql.add("select o.orderId_,o.proId_,o.rentTime_,o.settleState_,o.userId_,o.payID_,o.orderType_,o.coupon_,o.reliefDeposit_,o.sumOverMoney_,o.orderRentMoney_,");
		...
		if(payID_ != null && payID_ != ""){
			sql.add("and o.payID_ like '%s'" ,new String("%"+payID_+"%"));
		}
