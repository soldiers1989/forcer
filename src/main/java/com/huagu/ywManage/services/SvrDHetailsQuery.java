 ...
 *
 */
public class SvrDHetailsQuery extends AbstractService {
	...
	public IStatus execute(DataSet dataIn, DataSet dataOut) throws ServiceException {
		...
		sql.add("t.zhuCode_, t.OpenBoxTime_,t.leaveMess_ ,t.operateManName_,( select count(OpenBoxTime_) from %s  ) as openTime,t.nowLoss_," ,appdb.t_Operate);
