 ...
 *
 */
public class SvrYunWeiQuery extends AbstractService {

	@Override
	public IStatus execute(DataSet dataIn, DataSet dataOut) throws ServiceException {
		SqlQuery sql = new SqlQuery(this);
		sql.add("select t.UID_ ,t.operateId_,p.proZsImges_,t.createDate_,u.name_ userName,t.operateManId_,t.orderId_,t.boxId_, DATE_FORMAT(t.CloseBoxTime_,'%s') as CloseBoxTime_ ,c.name_  cabinetName, p.proName_,","%Y-%m-%d %H:%m:%s");
