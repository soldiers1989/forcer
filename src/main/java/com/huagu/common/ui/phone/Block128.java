...
public class Block128 extends Component {
	...
	private Span topRemark = new Span();
	private Span buttomRemark = new Span();
	...
	public void output(HtmlWriter html) {
		...
		html.print("</div>");
		html.print("<div class='m-mind'>");
		this.topRemark.output(html);
		this.buttomRemark.output(html);
		html.print("</div>");
	...
	public Span getButtomRemark() {
		return buttomRemark;
	}

	public Span getTopRemark() {
		return topRemark;
	}
