 ...
 *
 */
public class FrmCreditManageMent extends AbstractForm {
	@SuppressWarnings("unused")
	private static final Logger LOGGER = Logger.getLogger(FrmCreditManageMent.class);

	@Override
	public IPage execute() throws Exception {
		JspPage jsp = new JspPage(this, "creditManageMent/creditDeploy.jsp");
		...
		ParamUtil.addLog(this, "查询", "查询后台征信配置管理", "查询后台征信配置管理");
		return jsp;
	}
