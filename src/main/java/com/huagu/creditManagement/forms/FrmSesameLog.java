 ...
 *
 */
public class FrmSesameLog extends AbstractForm {
	@SuppressWarnings("unused")
	private static final Logger LOGGER = Logger.getLogger(FrmSesameLog.class);

	@Override
	public IPage execute() throws Exception {
		JspPage jsp = new JspPage(this, "creditManageMent/sesameLog.jsp");
		...
		ParamUtil.addLog(this, "查询", "查询后台用户芝麻信用列表", "查询后台用户芝麻信用列表");
	...
	public JsonPage upCredit() throws Exception {
		...
		/* throw new RuntimeException(upCredit.getMessage()); */
		return json;
	}
